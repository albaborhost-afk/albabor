...
<head>
    ...
    <title>{{ __('Nouveau mot de passe') }} - AlBabor</title>
            ...
            <div class="w-full max-w-md relative z-10">
                ...
                <div class="auth-glass-card p-8 sm:p-10 auth-card">
                    ...
                    <div class="text-center mb-7">
                        ...
                        <h2 class="text-2xl font-bold mb-2" style="color: #1B2A4A; letter-spacing: -0.02em;">{{ __('Nouveau mot de passe') }}</h2>
                        <p class="text-sm leading-relaxed mx-auto" style="color: #6B7B8D; max-width: 320px;">{{ __('Choisissez un nouveau mot de passe. Vos autres sessions seront deconnectees.') }}</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.update') }}" class="space-y-5">
                        ...
                        <div class="auth-form-group">
                            ...
                            <div class="relative">
                                ...
                                <input id="email" type="email" name="email" value="{{ strtolower(old('email', $email)) }}" required autocomplete="username" inputmode="email" autocapitalize="none" spellcheck="false"
                        ...
                        <div class="auth-form-group">
                            <label for="password" class="block text-sm font-semibold mb-2" style="color: #1B2A4A;">{{ __('Nouveau mot de passe') }}</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="w-[18px] h-[18px] auth-input-icon" style="color: #9BA8B7;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <input id="password" type="password" name="password" required autofocus autocomplete="new-password"
                                       class="auth-input w-full pl-12 pr-4 py-3.5 text-sm font-medium @error('password') !border-red-400 @enderror"
                                       placeholder="{{ __('8 caracteres minimum') }}">
                            </div>
                            @error('password')
                                <div class="auth-error">
                                    <p>
                        ...
                        <!-- Confirmation -->
                        <div class="auth-form-group">
                            <label for="password_confirmation" class="block text-sm font-semibold mb-2" style="color: #1B2A4A;">{{ __('Confirmer le mot de passe') }}</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="w-[18px] h-[18px] auth-input-icon" style="color: #9BA8B7;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password"
                                       class="auth-input w-full pl-12 pr-4 py-3.5 text-sm font-medium"
                                       placeholder="{{ __('Repetez le mot de passe') }}">
                            </div>
                        </div>
