...
<head>
    ...
    <title>{{ __('Inscription') }} - AlBabor</title>
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full px-12">
                ...
                <div class="space-y-5 max-w-sm w-full">
                    @foreach([
                        ['icon' => 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z', 'text' => __('Publiez vos annonces facilement')],
                        ['icon' => 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z', 'text' => __('Transactions securisees et verifiees')],
                        ['icon' => 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z', 'text' => __('Communaute de passionnes nautiques')],
                        ['icon' => 'M13 10V3L4 14h7v7l9-11h-7z', 'text' => __('Mise en ligne rapide et facile')],
                    ] as $item)
            ...
            <div class="w-full max-w-md py-4 relative z-10">
                ...
                <div class="auth-glass-card p-5 sm:p-7 lg:p-9 auth-card">
                    ...
                    <div class="text-center mb-7">
                        <h2 class="text-2xl font-bold mb-2" style="color: #1B2A4A; letter-spacing: -0.02em;">{{ __('Creer un compte') }}</h2>
                        <p class="text-sm" style="color: #6B7B8D;">{{ __('Rejoignez la communaute AlBabor') }}</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-4"
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div class="auth-form-group">
                                <label class="block text-sm font-semibold mb-1.5" style="color: #1B2A4A;">{{ __('Prénom') }}</label>
                                <div class="relative">
                            ...
                            <div class="auth-form-group">
                                <label class="block text-sm font-semibold mb-1.5" style="color: #1B2A4A;">{{ __('Nom') }}</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                        <svg class="w-4 h-4 auth-input-icon" style="color: #1B2A4A;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                        ...
                        <!-- Email -->
                        <div class="auth-form-group">
                            <label for="email" class="block text-sm font-semibold mb-1.5" style="color: #1B2A4A;">{{ __('Adresse email') }}</label>
                            <div class="relative">
                                ...
                                <input id="email" type="email" name="email" value="{{ strtolower(old('email', '')) }}" required autocomplete="username" inputmode="email" autocapitalize="none" spellcheck="false"
                        ...
                        <div class="auth-form-group" data-old-phone="{{ old('phone', '') }}" x-data="{
                            ...
                            <label for="phone_number" class="block text-sm font-semibold mb-1.5" style="color: #1B2A4A;">{{ __('Numero de telephone') }}</label>
                                    ...
                                    <div x-show="open" x-cloak @click.away="open = false; search = ''"
                                        ...
                                        <div class="p-2" style="border-bottom: 1px solid #E0E6ED;">
                                            <input type="text" x-model="search" x-ref="searchInput" @keydown.escape="open = false"
                                                   placeholder="{{ __('Rechercher un pays...') }}"
                                        ...
                                        <div class="overflow-y-auto" style="max-height: min(70vh, 480px); scrollbar-width: thin;">
                                            ...
                                            <div x-show="filteredCountries.length === 0" class="px-3 py-4 text-center text-sm" style="color: #9BA8B7;">{{ __('Aucun pays trouve') }}</div>
                                        </div>
                                    </div>
                                </div>
                                <!-- Phone number input -->
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            <div class="auth-form-group">
                                <label for="password" class="block text-sm font-semibold mb-1.5" style="color: #1B2A4A;">{{ __('Mot de passe') }}</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                        <svg class="w-4 h-4 auth-input-icon" style="color: #1B2A4A;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="auth-form-group">
                                <label for="password_confirmation" class="block text-sm font-semibold mb-1.5" style="color: #1B2A4A;">{{ __('Confirmer') }}</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                                        <svg class="w-4 h-4 auth-input-icon" style="color: #1B2A4A;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-center text-[11px] mt-5 px-4" style="color: #9BA8B7;">
                    {{ __("En vous inscrivant, vous acceptez nos Conditions d'utilisation et notre Politique de confidentialite.") }}
                </p>
