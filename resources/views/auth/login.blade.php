    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col justify-center items-center w-full px-12">
                ...
                <p class="text-lg mb-10 text-center auth-subheading" style="color: rgba(255,255,255,0.7);">{{ __('en Algerie') }}</p>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="space-y-5" x-data="{ showPassword: false }">
                        ...
                        <div class="auth-form-group">
                            ...
                            <div class="relative">
                                ...
                                <input id="email" type="email" name="email" value="{{ strtolower(old('email', '')) }}" required autofocus autocomplete="username" inputmode="email" autocapitalize="none" spellcheck="false"
