...
>
    @php
        ...
        $typeOffreLabels = ['negociable' => 'Negociable', 'fix' => 'Prix fixe', 'offert' => 'Offert (offre reçue)'];
        ...
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-10">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
                ...
                <div class="lg:col-span-2 space-y-3 sm:space-y-6 reveal-left" style="transition-delay: 0.1s;">
                        ...
                        <div class="p-4 sm:p-5 pb-4 annonce-price-hero">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-end gap-2 sm:gap-3">
                                ...
                                <div class="flex items-center gap-2 flex-wrap">
                                    ...
                                    @endif
                                    <span class="text-xs font-semibold px-2.5 py-1 rounded-lg bg-cyan-50 text-cyan-800">{{ $listing->type_offre_label }}</span>
                    ...
                    <div class="lg:hidden">@include('listings.partials.seller-contact', ['contactPlacement' => 'mobile'])</div>
                    ...
                    <div class="listing-card-frame rounded-3xl p-3 sm:p-6">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3">
                            ...
                            @foreach([
                                ...
                                'immatriculation_autre' => ['label' => 'Pays d’immatriculation', 'icon' => '🌍'],
                    ...
                    <div class="listing-card-frame rounded-3xl p-3 sm:p-6">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3">
                            @foreach([
                                ...
                                'tonnage' => ['label' => 'Poids', 'unit' => strtoupper($listing->getSpec('dimensions', 'tonnage_unit', 'kg')), 'icon' => '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/></svg>'],
                                'tonnage_t' => ['label' => 'Tonnage', 'unit' => 'T', 'icon' => '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/></svg>'],
                    ...
                    <div class="listing-card-frame rounded-3xl p-3 sm:p-6">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3">
                            @foreach([
                                ...
                                'type_helice' => ['label' => 'Type d’hélice', 'unit' => '', 'icon' => '⚙'],
                    ...
                    <div class="listing-card-frame rounded-3xl p-3 sm:p-6">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-2 sm:gap-3">
                            @foreach([
                                'total_carburant' => ['label' => 'Carburant total', 'icon' => '⛽'],
                                'capacite_totale' => ['label' => 'Capacité totale', 'icon' => '▤'],
                                'reservoir_carburant' => ['label' => 'Carburant par réservoir', 'icon' => '<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z"/></svg>'],
                    ...
                    <div class="listing-card-frame rounded-3xl p-3 sm:p-6">
                        ...
                        @php
                            $tagSections = [
                                ...
                                'extras' => ['label' => 'Options / Équipements en plus', 'color' => '#8E44AD', 'icon' => '⭐'],
                ...
                <div class="lg:col-span-1 space-y-5 reveal-right" style="transition-delay: 0.25s;">
                    ...
                    <div class="hidden lg:block">@include('listings.partials.seller-contact', ['contactPlacement' => 'desktop'])</div>
