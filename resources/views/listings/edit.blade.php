        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <form action="{{ route('listings.update', $listing) }}" method="POST" enctype="multipart/form-data"
                ...
                <div class="bg-white rounded-2xl p-6" style="box-shadow: 0 10px 25px rgba(0,0,0,0.06);"
                     ...
                     ">
                    <h2 class="text-base font-semibold mb-4 flex items-center gap-2" style="color: #1B2A4A;">
                        <span class="w-7 h-7 rounded-lg flex items-center justify-center text-white text-sm font-bold gradient-primary" title="Étape 5">5</span>
                        <span class="flex flex-col leading-tight">
                            <span>Reservoirs</span>
                            <span class="text-[10px] font-normal" style="color: #9BA8B7;">Calcul automatique de la capacité totale</span>
                        </span>
                    </h2>
                ...
                <div class="bg-white rounded-2xl p-6" style="box-shadow: 0 10px 25px rgba(0,0,0,0.06);" x-show="category" x-transition>
                    ...
                    {{-- Price : entree libre + 2 boutons d'unite (Milliard / Million) --}}
                    @php
                    ...
                    <div class="mb-5" x-data="{
                        ...
                        <div class="relative">
                            <input type="number" x-model="rawValue" required min="0" step="any"
                                   :placeholder="unit === 'milliard' ? 'Ex: 4,5' : (unit === 'million' ? 'Ex: 900' : 'Ex: 1400000')"
                                   class="glass-input w-full rounded-xl px-4 py-3 pr-24 text-lg font-semibold" style="color: #1B4F72;">
                            <div class="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                                <span class="font-bold text-sm px-2 py-1 rounded-lg whitespace-nowrap"
                    ...
                    <div class="mb-2" x-data="{
                        selected: '{{ old('pays', $listing->pays) }}',
                        countries: [
