    ...
    <div style="background: #F0F4F8;" class="py-10 pb-16">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
                @foreach([
                    ['icon' => 'M15 12a3 3 0 11-6 0 3 3 0 016 0z', 'title' => __('messages.banner_perk_visibility_title'), 'text' => __('messages.banner_perk_visibility_text')],
                    ['icon' => 'M9 19V6l12-3v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z', 'title' => __('messages.banner_perk_audience_title'), 'text' => __('messages.banner_perk_audience_text')],
                    ['icon' => 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z', 'title' => __('messages.banner_perk_stats_title'), 'text' => __('messages.banner_perk_stats_text')],
                ] as $perk)
