...
return new class extends Migration
{
        ...
        if ($driver === 'sqlite') {
            ...
            DB::statement('
                CREATE TABLE payments_new (
                    ...
                    method TEXT NOT NULL CHECK (method IN (\'baridimob\',\'ccp\',\'bank_transfer\',\'paypal\',\'redotpay\',\'card\')),
            ...
            // MySQL 8.4
            DB::statement("ALTER TABLE payments MODIFY COLUMN method ENUM('baridimob','ccp','bank_transfer','paypal','redotpay','card') NOT NULL");
        }
    }
    ...
    public function down(): void
    {
        ...
        if ($driver === 'sqlite') {
            ...
            DB::statement('INSERT INTO payments_new SELECT * FROM payments WHERE method IN (\'baridimob\',\'ccp\',\'bank_transfer\',\'paypal\',\'redotpay\')');
            DB::statement('DROP TABLE payments');
            DB::statement('ALTER TABLE payments_new RENAME TO payments');
            ...
            DB::statement("ALTER TABLE payments MODIFY COLUMN method ENUM('baridimob','ccp','bank_transfer','paypal','redotpay') NOT NULL");
        }
    }
};
